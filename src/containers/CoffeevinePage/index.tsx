...
import "./index.css";
import img1 from "../../images/Santuario_Sul.png";
import img2 from "../../images/Kenya_coffee.png";
import img3 from "../../images/puchero_coffee.png";
...
export function CoffeevinePage() {
  ...
  const logo = "https://bestcomma-videos.s3-us-west-1.amazonaws.com/bestcomma_demo/Coffeevine_Logo.png";
  let video_srcs = [
    "https://bestcomma-videos.s3-us-west-1.amazonaws.com/bestcomma_demo/coffeevine_intro.mp4",
    "https://bestcomma-videos.s3-us-west-1.amazonaws.com/bestcomma_demo/coffevine_part1.mp4",
    "https://bestcomma-videos.s3-us-west-1.amazonaws.com/bestcomma_demo/coffeevinw_part2.mp4",
    "https://bestcomma-videos.s3-us-west-1.amazonaws.com/bestcomma_demo/coffeevine_part3.mp4",
  ];

  let childRefs = video_srcs.map(() => createRef()); //create a childref for each video

  let product_links = [
    "https://thecoffeevine.com/shop/our-coffee-subscription-box/",
    "https://thecoffeevine.com/shop/our-coffee-subscription-box/",
    "https://thecoffeevine.com/shop/our-coffee-subscription-box/",
  ];
  ...
  let product_names = ["Santuario Sul", "Kenya Rwegheta", "Puchero Todos Santos"];
  ...
  return (
    <ThemeProvider theme={theme}>
      <article>
        <Helmet>
          <title>CoffeevinePage Page</title>
          <meta
            name="description"
        ...
        {video_ind > 0 &&
          <IconButton className="button-animation" key="prev"
            style={{
              ...
              textTransform: "none", backgroundColor: "rgba(255, 237, 216, 0.8)",
            }}
            onClick={() => {
        ...
        <div className="video-block" style={{ overflow: "hidden", position: "relative", height: height }}>
          ...
          {video_ind === 0 && !show_menu &&
            <Button className="button-animation" variant="contained" key="see-my-product"
              style={{
                position: "absolute", backgroundColor: "rgba(255, 237, 216, 0.8)", alignSelf: "center",
                color: "black", padding: "15px 30px", marginBottom: 10,
          ...
          {video_ind > 0 &&
            <IconButton className="button-animation" key="next" style={{
              position: "absolute", color: "black", backgroundColor: "rgba(255, 237, 216, 0.8)",
...

          {
            ...
            <Button className="button-animation" variant="outlined" color="secondary" key="more"
              ...
              style={{
                ...
                backgroundColor: "rgba(255, 237, 216, 0.8)", alignSelf: "center",
